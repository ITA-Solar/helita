...
# -*- coding: utf-8 -*-
#
# bifrostDocs documentation build configuration file, created by
...
htmlhelp_basename = 'bifrostDocsdoc'
...
latex_documents = [
    (master_doc, 'bifrostDocs.tex', 'bifrostDocs Documentation',
     'Carmel Baharav', 'manual'),
]
...
man_pages = [
    (master_doc, 'bifrostdocs', 'bifrostDocs Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'bifrostDocs', 'bifrostDocs Documentation',
     author, 'bifrostDocs', 'One line description of project.',
     'Miscellaneous'),
]
